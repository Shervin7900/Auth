...
using Lib.Models;
using Lib.Models.Dto.Requests;
using Lib.Models.Dto.Response;
...
namespace Lib.Controllers
{
    ...
    public class AuthManagementController : ControllerBase
    {
        ...
        private readonly LibContext _libDbContext;
        ...
        private async Task<AuthResult> GenerateJwtToken(User user)
        {
            ...
            await _libDbContext.RefreshTokens.AddAsync(refreshToken);
            await _libDbContext.SaveChangesAsync();
        ...
        private async Task<AuthResult> VerifyToken(TokenRequest tokenRequest)
        {
            ...
            try
            {
                ...
                var storedRefreshToken = await _libDbContext.RefreshTokens.FirstOrDefaultAsync(x => x.Token == tokenRequest.RefreshToken);
                ...
                _libDbContext.RefreshTokens.Update(storedRefreshToken);
                await _libDbContext.SaveChangesAsync();
        ...
        private async Task<List<Claim>> GetValidClaims(User user)
        {
            ...
            var claims = new List<Claim>
            {
                ...
                new Claim(JwtRegisteredClaimNames.Sub, user.Email),
                new Claim(JwtRegisteredClaimNames.Jti, Guid.NewGuid().ToString()),
                new Claim(_options.ClaimsIdentity.UserIdClaimType, user.UserId.ToString()),
